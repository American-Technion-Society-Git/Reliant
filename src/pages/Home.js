                    ...
                    <div className="hero_inner">
                        ...
                        <div className="search">
                            <form>
                                ...
                                <div class="searchfield" id="searchbedpar"><div class="selectric-wrapper"><div class="selectric-hide-select"><select id="searchbed" name="beds" tabindex="-1"><option selected="true" disabled="disabled">Bedroom</option><option value="1">1</option><option value="2">2</option><option value="3">3</option></select></div><div class="selectric-items" tabindex="-1"><div class="selectric-scroll"><ul><li data-index="0" class="disabled selected">Bedroom</li><li data-index="1" class="">1</li><li data-index="2" class="">2</li><li data-index="3" class="last">3</li></ul></div></div><input class="selectric-input" tabindex="0"></input></div></div>
