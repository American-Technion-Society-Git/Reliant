...
const CommunityTable = ({ communitiesData }) => {
  ...
  const SubmitEdit = async () => {
    setBtnDisabled(true)
    const img = imgUrl == "" ? updateObj.featured_image : imgUrl;
    const finalObj = { ...updateObj, featured_image: img }
  ...
  return (
    <React.Fragment>
      ...
      <div class="modal fade" id="communityUpdateModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <label for="update_community_img_uploader" class="custom-file-upload">
                {
                  imgUploaded ?
                    "Image Uploaded"
                    :
              ...
              <input id='update_community_img_uploader' type="file" onChange={(e) => {
